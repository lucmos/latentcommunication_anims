...
class TitleAnimation(Scene):
    def construct(self):
        paper_title = Tex("Relative representations", font_size=72).to_edge(LEFT).shift(UP * 2.5)
        paper_title_sub = Tex("enable zero-shot latent space communication", font_size=52)
